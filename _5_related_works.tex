...
These studies establish that workload and arrival control can be coordinated.
Per-request adaptation to a remaining end-to-end budget is also established~\cite{timecard-sosp}.
What differs in our capture pipeline is how the two controls are coupled across consecutive captures: admission controls optional stages of the current capture, while pacing controls when the next capture enters the shared draft worker.
