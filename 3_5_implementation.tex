...
The draft pipeline therefore provides the pacing decision to that component over the framework's existing event channel.
...
When the watchdog expires, the watchdog-fallback thread performs the fallback.
