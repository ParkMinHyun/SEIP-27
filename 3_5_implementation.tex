...
Admission therefore runs in the same lifecycle as the estimator and queries remaining-sequence estimates directly.
...
Both modules learn durations from execution on the current device instead of using per-model timing tables or device-state signals such as thermal level.
