...
We evaluate whether the Budget-Aware Draft Controller prevents Capture Timeout while retaining optional stages and capture responsiveness on the production-derived camera stack.
