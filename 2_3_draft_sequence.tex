...
To reduce this gap, we implemented lightweight multi-frame composition in the Draft Sequence on supported models.
However, the additional processing can make later captures wait longer for the single Draft worker.
