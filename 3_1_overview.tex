...
Their shared runtime state connects the two decisions: when admission removes optional stages, pacing adjusts its duration reserve to reflect the stages still eligible for execution.
