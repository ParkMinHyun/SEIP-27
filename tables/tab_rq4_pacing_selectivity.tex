...
% not be mixed; the header of tab_rq4_pacing_summary.tex records the same
% 141-against-140 defect in an earlier table.  On the counts the ratios are
...
% docs/rq3-current.md maps burst -> run for printed text, RQ1 counts runs, and
