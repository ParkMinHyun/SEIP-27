...
\begin{table*}[t]
  ...
  \caption{RQ1 controller-off failure reference and retained
  full-controller behavior.  Timeout onset is the earliest first-timeout
  capture across ten controller-off trials.  $M$, $S$ and Activated are
  per-run means over the first 5 and first 30 captures; $M$ and $S$ count
  captures, out of 5 and 30, and Activated counts paced transitions, out of 4
  and 29.}
  ...
  \begin{tabular}{|c|c|c|r||r||r||rr|rr||rr|rr|}
    ...
    \multicolumn{1}{c||}{\multirow{2}{*}{\makecell[c]{%
      \textbf{Controller-off}\\\textbf{reference}}}} &
    \multicolumn{9}{c|}{\textbf{Full-controller behavior}} \\
    \cline{6-14}
    & & & &
    \multicolumn{1}{c||}{} &
