...
\begin{table}[t]
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{0.40\columnwidth}
    ...
    \addlinespace
      No external memory pressure & Production-default condition without externally induced memory pressure. \\
    \addlinespace
      Capture started at overheat Lv4 & Matches the motivating timeout condition and the production guard cutoff for optional stages. \\
    \bottomrule
  \end{tabular}
