...
\begin{table}[t]
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{0.29\columnwidth}
    ...
    Shot mode & \multicolumn{2}{>{\raggedright\arraybackslash}p{0.66\columnwidth}}{1$\times$ zoom with HDR} \\
    ...
    Memory pressure & \multicolumn{2}{>{\raggedright\arraybackslash}p{0.66\columnwidth}}{AnTuTu Benchmark~11.1.4 running alongside the camera} \\
