...
\begin{table}[t]
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{0.29\columnwidth}
    ...
    Capture conditions & \multicolumn{2}{>{\raggedright\arraybackslash}p{0.66\columnwidth}}{12MP normal; 24MP under memory pressure} \\
    Memory pressure & \multicolumn{2}{>{\raggedright\arraybackslash}p{0.66\columnwidth}}{AnTuTu Benchmark~11.1.4 memory-stress workload} \\
    ...
    Capture request & \multicolumn{2}{>{\raggedright\arraybackslash}p{0.66\columnwidth}}{Continuous shutter-input injection via an ADB loop} \\
    Repetitions & \multicolumn{2}{>{\raggedright\arraybackslash}p{0.66\columnwidth}}{Ten 30-capture runs per condition and level} \\
    \bottomrule
  \end{tabular}}
\end{table}