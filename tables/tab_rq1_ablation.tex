...
%              Table~\ref{tab:rq3_pacing_summary} uses throughout and the same
...
\begin{table}[t]
  ...
  % pacing delay as $d$ throughout Table~\ref{tab:rq3_pacing_summary}, and one
  ...
  % begins.  This matches Table~\ref{tab:rq3_pacing_summary} and
