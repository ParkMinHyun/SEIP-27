...
\begin{table}[t]
 \centering
 \caption{Earliest Capture Timeout onset across capture conditions.}
 ...
 Each entry reports the earliest capture index at which Capture Timeout occurred in any of ten 30-capture trials. A dash indicates no timeout within 30 captures.\par
 Earlier onset:~%
