...
\begin{table}[t]
 \centering
 \caption{Capture Timeout onset in guard-bypassed S26 Ultra validation.}
 ...
 Each entry is the earliest first-timeout capture index across ten 30-capture trials; -- means no timeout within the horizon.\par
 Earlier onset:~%
