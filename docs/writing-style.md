...
point \(j\). At pacing decision time \(t_i\), \(T_i\) is the remaining window
of the capture whose Draft Sequence is predicted to complete at
\(t^{\mathrm{end}}\), and the resulting \(d_i\) applies to the next capture
