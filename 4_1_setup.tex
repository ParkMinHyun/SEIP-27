...
% Float placement: docs/exhibits.md#tab_rq1_end_to_end_summary
...
An ADB loop provides a reproducible stress workload rather than emulating ordinary user interaction. 
It issues each shutter input as soon as the application-facing \texttt{captureAvailable} path permits, thereby saturating the exposed request rate.
