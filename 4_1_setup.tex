...
A reproducible ADB loop issues each shutter input as soon as the application receives the \texttt{captureAvailable} callback, saturating the exposed request rate.
