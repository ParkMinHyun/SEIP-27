...
`tables/tab_rq3_admission_quality.tex` (Table V, 2026-09-26) prints the RQ3-pool
...
("Point estimate"), against U at the printed 3,470 / 98 / 5 / 173, with U's four
condition-stage rows nested beneath it.
