...
Capture is a core cross-layer workflow spanning these components, so a failure discovered late can require a firmware update rather than an application-only fix.
