...
We include recorded pacing decisions with a backlog reconstructed from the completed trace.
Panel~(a) groups decisions by this measured backlog \(B_i\) as a fraction of the Capture Timeout budget.
...
Among captures finishing with less than 20\%, 10\%, and 5\% of the timeout budget remaining, pacing engaged on 85.4\%, 92.3\%, and 95.7\%, respectively.
