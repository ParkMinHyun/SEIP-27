...
\usepackage{colortbl}
\usepackage{tikz}
\usetikzlibrary{patterns,decorations.pathreplacing,positioning}
...
\title{Shooting on a Deadline: Learning Tail-Latency-Safe Admission Control \\ for Draft Sequences in a Commercial Android Camera Framework}
