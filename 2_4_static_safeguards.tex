...
Enabling the Draft Sequence's lightweight multi-frame composition requires the whole sequence, including encoding and saving, to finish before Capture Timeout.
The production thermal guard restricts optional stages using a cutoff that does not reflect each capture's remaining time.
